...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <h3><span class="turquoise">E</span><span>-COMPTABLE</span></h3>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="/login">Conexion</a>
                </li>
            </ul>
        </div>
    </nav> <!-- end of navbar -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h2><span class="turquoise">E-Comptable</span></br> Platforme de comptabilité qui correspond le mieux a votre activité</h2>
                            <p class="p-large">Gagnez du temps en optimisant vos processus.</p>
                            <a class="btn-solid-lg page-scroll" href="/login">Connexion</a>
                    ...
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                ...
                                <div class="media-body">Automation de redaction des enregistrements des documents comptable (Bilan,CPC,Journal...)</div>
                            </li>
                        </ul>
                ...
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <i class="fas fa-check"></i>
                                <div class="media-body">Notre Platforme assure la communication entre les dffférents membres d'organisme. </div>
                            </li>
                        </ul>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <div class="media-body">Digi compta s'adresse de facon directe au business qui ont besoins d'automatiser leur flux de travail, vous devriez avoir au moins des connaissances de comptabilité afin ? d'utiliser le maximum de notre plateforme. </div>
                            </li>
                        </ul>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            <li class="media">
                                <div class="media-body">des avantages fondamentaux de nombreuses solutions Web et applications FinTech, c'est leur capacité à automatiser les tâches financieres et administratives de base pour votre cabinet tout comme pour vos clients. La saisie des dépenses, le rapprochemen bancaire.. </div>
                            </li>
                        </ul>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="list-unstyled li-space-lg">
                        ...
                        <li><i class="fas fa-phone"></i><a class="turquoise" href="tel:003024630820">+212 55699999</a></li>
                        <li><i class="fas fa-envelope"></i><a class="turquoise" href="mailto:office@evolo.com">email@email.com</a></li>
                    </ul>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
